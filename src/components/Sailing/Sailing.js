	...
	renderOfferPrice() {
		...
		return (
			<div className='sailing-price'>
				<div className='price'>{totalCostCurrency.toLocaleString()} {totalCost}</div>
				<button className='themed primary'>
					Select
				</button>
				<div
	...
	renderTimeline(computedOffsets) {
		...
		return (
			<div className='timeline'>
				...
				{offsets.map(
					({date, format, offset, mark, text}, key) => {
						let left = offset * 100,
		...
		return (
			<div className='details'>
				<div className='content'>
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid, consectetur corporis dolor
						dolore
						ea incidunt, ipsam iste molestiae neque nisi, quae rem ut veniam! Harum id quae temporibus.
						Optio,
						ratione.
					</p>
					<p>
